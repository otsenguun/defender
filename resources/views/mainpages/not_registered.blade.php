...
@section('parentPageTitle', 'Not registered client')
@section('title', 'Not registered client Details')
        ...
        <div class="card">
            ...
            <ul class="list-group">
                <li class="list-group-item">
                   ...
                   <p  class="mb-0"> <small class="text-muted">UUID: </small>{{$info['sysinfo']->uuid}}</p>
               </li>
       
                <li class="list-group-item">
                    <p  class="mb-0"><small class="text-muted">Frist log: </small>{{$info['sysinfo']->created_at}}</p>
                </li>
                <li class="list-group-item">
                    <p  class="mb-0"><small class="text-muted">Last log: </small>{{$info['sysinfo']->updated_at}}</p>
                </li>
