        ...
        <div class="card">
            <div class="body">
                ...
                <div class="form-group mb-4">
                    <label class="d-block">{{$sysinfo->os_name}} <span class="float-right">{{$sysinfo->count}}</span></label>
                ...
                <div class="row text-center">
                    <div class="col-lg-12 col-md-5">
                        <div class="text-center">
                            <input type="text" class="knob" value="{{$totals['unregper']}}" data-width="68" data-height="68" data-thickness="0.1" data-bgColor="#383b40" data-fgColor="#17C2D7">
                        </div>
                        <label class="mb-0 mt-2">Clients</label>
                        <h4 class="h4 mb-0 font-weight-bold text-cyan">{{$totals['clients'] - $totals['unreg']}} / {{$totals['clients']}}</h4>
                    ...
                    <div class="col-lg-12 col-md-5">
                        <div class="text-center">
                            <input type="text" class="knob" value="{{$totals['threat_percent']}}" data-width="68" data-height="68" data-thickness="0.1" data-bgColor="#383b40" data-fgColor="#dc3545">
                        </div>
                        <label class="mb-0 mt-2">ActionSuccess</label>
                        <h4 class="h4 mb-0 font-weight-bold text-info">{{$totals['threat_totals_false']}} / {{$totals['threat_totals_true']}}</h4>
                    </div>
                </div>
            </div>
        </div>
