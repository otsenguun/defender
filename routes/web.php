...
Route::get('/Main', "DataController@dashboard");
Route::get('/home', "DataController@dashboard");
Route::get('/', "DataController@dashboard");
Route::get('/Threats', "MainController@Threats");
Route::get('/home2', "DataController@dashboardComp");
Route::resource('computer', 'ComputerController');
Route::get('/showClient/{uuid}', "MainController@Client");
Route::get('getLineData/{start}/{end}/{type}', "MainController@updatedata");

Route::get('/clients', "MainController@Clients")->middleware('is-master');
Route::resource('company', 'CompanyController')->middleware('is-master');
Route::resource('user', 'UserController')->middleware('is-master');
Route::get('updateData/{id}/{table}', "ComputerController@updatedata")->middleware('is-master');
Route::get('delete_user/{id}', "UserController@destroy")->middleware('is-master');
Route::get('delete_computer/{id}', "ComputerController@destroy")->middleware('is-master');
